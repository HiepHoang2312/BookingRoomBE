...
require("./routes/DichvuRoom")(app);
require("./routes/RoomLoairoom")(app);
require("./routes/RoomNgaydi")(app);
require("./routes/RoomDiadiem")(app);
require("./routes/Chitieu")(app);
require("./routes/Khuyenmai")(app);
require("./routes/RoomKhuyenmai")(app);
